...
function showMsg(e){
  ...
  var getGenus = $("input[@name='getGenus']").val();
	...
	$.post("accountadmin/accountadmin.php",
		{getFamily:getFamily,getGenus:getGenus,author_family:author_family,author_genus:author_genus,author_species:author_species,reviewer_family:reviewer_family,reviewer_genus:reviewer_genus,reviewer_species:reviewer_species},
		function(data){//do something
			...
			if(data == 'Invalid query'){
				...
				//document.location='./accountadmin/accountadmin.php';
				document.location='useradmin.php';
			}
...
$(document).ready(function(e){
	...
	for(i=1;i<=genus_counter;i++){
		...
		if((temp == getGenus)){	
			...
			// Modified at May 18, 2009 Monday 17:51
		}
		if((temp2 == getGenus)){	
