...
<title>Taxon Profiles Admin</title>
...
<div id="wrap">
  ...
  <div id="content-wrap">
    <div id="main">
      <h3>Upload your photo or file:</h3>
      <p>Aollowed Upload File Format: JPG, GIF</p>
      <p>Maximum Size of your upload file: 2048 KB (2 MB)</p>
      <form name="form" action="" method="POST" enctype="multipart/form-data">
        ...
        <?
			...
			$_SESSION['ccmeta_id'] = $_GET['ccmetaid'];
			$_SESSION['img_desc'] = $_GET['imgdesc'];
        	if($_SESSION['ccdoc_id'] && $_SESSION['ccmeta_id']){
        		//docedit.php?docid=1&lv=species&doc_type=author
        		echo "<a href=\"docedit.php?docid=".$_GET['docid']."&lv=".$_GET['lv']."&doc_type=".$_GET[doc_type]."\">Back to author account edit page</a>";
  			}else{
        		echo "<a href=\"userprofileedit.php\">Back to user profile edit page</a>";
        	}
        ?>
      </form>
      <!--				
