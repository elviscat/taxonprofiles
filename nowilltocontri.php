...
<title>CypCom No Willing to Contribute</title>
...
<div id="wrap">
	...
	<div id="content-wrap">
		...
		<div id="main">				
            <h3>Sorry, your didn't set yuor willing to contribute.</h3>
			<p>
            <a href="useradmin.php">Come Back to Useradmin?</a>
            </p>
			<p>
            <a href="contriedit.php">Go to set up your contribution?</a>
            </p>
			<br />
			<!--				
