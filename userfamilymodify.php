...
<title>CypCom Modify Your Family</title>
<script src="jquery/jquery.js" type="text/javascript" language="javascript"></script>
<script src="userfamilymodify/userfamilymodify.js" type="text/javascript" language="javascript"></script>
<link rel=stylesheet type="text/css" href="userfamilymodify/userfamilymodify.css">
</head>
...
<div id="msg"></div>
			...
			<h3>Modify Family under your view</h3>		
<?
//Connect to database
$link = mysql_connect($host , $dbuser ,$dbpasswd); 
if (!$link) {
...
mysql_select_db($dbname);
//now validating the username and password
$sql = "SELECT * FROM cfamily WHERE owner = '".$_SESSION['username']."' AND cfid='".$_GET['cfid']."'";
//echo $sql;
...
?>			
            <p>		
				...
				<input name="family_name" type="text" id="family_name" value="<? echo $family_name; ?>" maxlength="50" size="50" />
				<label>Description : </label>
				<textarea name="family_desc" id="family_desc" value="" COLS="40" ROWS="6"><? echo $family_desc; ?></textarea><br>
                <input name="cfid" type="hidden" id="cfid" value="<? echo $_GET['cfid']; ?>" maxlength="50" size="50" />
                <input class="button" type="submit" value="Modify" name="Submit" id="submit" />
