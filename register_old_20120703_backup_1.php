	...
	<div id="content-wrap">
		...
		<div id="main">				
			...
			<p>		
				...
				<input name="username" type="text" id="username" value="User Name" maxlength="20" size="40" /><BR />
				...
				<input name="eml" type="text" id="eml" value="user@cypcom.org" maxlength="40" size="60" /><BR />
                <font color="red">*Please key in your email address</font>
				<label>Email Address Again: </label>
				<input name="emlagain" type="text" id="emlagain" value="user@cypcom.org" maxlength="40" size="60" /><BR />
