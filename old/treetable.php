...
<title>CypCom Tree Table</title>
<script src="jquery/jquery.js" type="text/javascript" language="javascript"></script>
<script src="treetable/treetable.js" type="text/javascript" language="javascript"></script>
<link rel=stylesheet type="text/css" href="treetable/treetable.css">
</head>
...
<div id="msg"></div>
            ...
            <h2>View your Current Profile as Author and Reviewer</h2>
...
if(mysql_num_rows($result2)>0){
	...
	while ($nb2=mysql_fetch_array($result2)) {
		...
		if($_GET['family'] == $nb2[0]){
			echo "<a href=\"treetable.php\"><img src=\"./images/collapse.png\" width=\"16\" height=\"16\" border=\"1\"></a>";
		}else{
			echo "<a href=\"treetable.php?family=".$nb2[0]."\"><img src=\"./images/expand.png\" width=\"16\" height=\"16\" border=\"1\"></a>";
		}
		echo $nb2[0]."</td>";
		...
		if (isset($_GET['family']) && $_GET['family'] == $nb2[0]){
			...
			while ($nb3 = mysql_fetch_array($result3)) {			
				...
				if($_GET['genus'] == $nb3[0]){
					echo "<a href=\"treetable.php?family=".$nb2[0]."\"><img src=\"./images/collapse.png\" width=\"16\" height=\"16\" border=\"1\"></a>";
				}else{
					echo "<a href=\"treetable.php?family=".$nb2[0]."&genus=".$nb3[0]."\"><img src=\"./images/expand.png\" width=\"16\" height=\"16\" border=\"1\"></a>";
				}
				echo $nb3[0]."</td>";
				echo "<td align=\"center\"><input type=\"checkbox\" name=\"author_genus_".$counter1."\" value=\"".$nb3[0]."\" ";
				for($i = 0; $i <= sizeof($author_genus); $i++){
					if($author_genus[$i] == $nb3[0]){
						echo "checked";
						break;
					}
				}
