...
if(mysql_num_rows($result_duplicated_doc_check)>0){
	...
	//docid, ref_uid, title, content, lv, taxon_name, credatetime, expiration, reviewer, state, decision
	echo "<label><h3>Creating Document for ".$taxon_name." at ".$level." level</h3></label>\n";
	echo "<label><p>Create By: ".user_name($ref_uid, 'uid', '3', 'user')." on ".$initime."</p></label>\n";
	echo "<label><p>Current State: ".doc_state('-1')."</p></label>\n";
