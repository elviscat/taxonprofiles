...
<title>CypCom Manage Your Taxa/Species Account</title>
<script src="search_species/jquery.js" type="text/javascript" language="javascript"></script>
...
<div id="msg"></div>
            ...
            <h2>Your Current Contributions For Cypriniformes Commons</h2>

<?
$sql2 = "SELECT * FROM cfamily WHERE owner ='".$_SESSION['username']."'";
...
if(mysql_num_rows($result2)>0){
	...
	echo "<td align=\"center\">Initial Time</td>";
	echo "<td align=\"center\">Expired Time</td>";
	echo "<td align=\"center\">State</td>";
	while ($nb2=mysql_fetch_array($result2)) {
		echo "<tr bgcolor=\"#FDDC99\">";
		echo "<td align=\"center\"><a href=\"userfamilymodify.php?cfid=".$nb2[0]."\">".$nb2[1]."</a></td>";
		echo "<td align=\"center\">".$nb2[2]."</td>";
		//echo "<td align=\"center\">".$nb2[3]."</td>";
		echo "<td align=\"center\">".$nb2[4]."</td>";
		echo "<td align=\"center\">".$nb2[5]."</td>";
		echo "<td align=\"center\">".$nb2[6]."</td>";
		echo "</tr>";
	}
	echo "</table>";
}else{
...
mysql_close($link);
?>            
			<h3>Your Reviewer List</h3>
            <h2>Your Genus Account List under your view</h2>
            <h2>Your Species Account List under your view</h2>
            <!--				
