...
<title>Taxon Profiles Login</title>
	...
	<div id="content-wrap">
		...
		<div id="main">				
			...
			<p>		
				...
				<input name="username" type="text" id="username" value="User Name" maxlength="40" size="40" />
                <!--<input name="username" value="Your Name" type="text" size="30" />-->
				<label>Password : </label>
				<input name="password" type="password" id="password" value="123456" maxlength="40" size="40" />
            ...
            <p><a href="register.php">Register a new account?</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="requestpasswd.php">Forgot your password?</a></p>
            <br />
			<!--				
