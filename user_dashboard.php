  ...
  <div id="content-wrap">
    <div id="main">
      ...
      -->
		...
		<p>
			<a href="treelist.php">By Tree-View Biological Classification</a>
		</p>
		<p>
			<a href="searchspecies.php">By Search Taxa</a>
		</p>
		</form>
      ...
      <form method="post" action="" id="edit_contribution_form">
		<p>
		<a href="docadmin.php?doc_type=author">Manage the taxon profiles-document that you author</a>
        </p>
        <p>
		<a href="docadmin.php?doc_type=reviewer">Manage the taxon profiles-document that you review</a>
        </p>
        <!--
        <p>
