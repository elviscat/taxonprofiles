...
<title>CypCom Administrator Admin</title>
  ...
  <div id="content-wrap">
    <div id="main">
      ...
      <form method="post" action="" id="speciestableediting">
        <p><a href="speciestableediting.php">Edit the species data using table/grid</a></p>
      </form>
      <h3>Document Metadata Table/Grid Editing</h3>
      <form method="post" action="" id="metadatatableediting">
        <p><a href="metadatatableediting.php">Edit the document metadata using table/grid</a></p>
      </form>
