...
<title>Taxon Profiles Administrator Admin</title>
...
<div id="wrap">
  ...
  <div id="content-wrap">
    <div id="main">
      <p>Hi, <font color="blue"><? echo $_SESSION['name'];?></font>. Welcome to your admin manage page.</p>
      <h3>Species Editing</h3>
      <form method="post" action="" id="edit_profile_form">
        <p><a href="speciesEditor.php">Edit the species data</a></p>
      </form>
      <!--
      <h3>Blog Management</h3>
      <form method="post" action="" id="blog">
        <p><a href="../blog/manage.php">Go to your Blog!</a></p>
      </form>
      -->
      <h3>Species Table/Grid Editing</h3>
		<!--
		...
		-->
      <form method="post" action="" id="speciestableediting">
        <SCRIPT language="JavaScript1.2">
			function openwindow()
			{
				window.open("admin/speciestableediting.php","mywindow","menubar=1,resizable=1,width=920,height=350");
			}
		</SCRIPT>
        <p><a href="javascript: openwindow()" >Edit the species data using table/grid</a></p>
      </form>
      
      <h3>Document Metadata Table/Grid Editing</h3>
      <form method="post" action="" id="metadatatableediting">
        <SCRIPT language="JavaScript1.2">
			function openwindow2()
			{
				window.open("admin/metadatatableediting.php","mywindow2","menubar=1,resizable=1,width=1300,height=350");
			}
		</SCRIPT>
        <p><a href="javascript: openwindow2()">Edit the document metadata using table/grid</a></p>
      </form>
      <h3>Account Review Panel</h3>
      <form method="post" action="" id="reviewpanel">
        <p><a href="reviewpanel.php">Go to review panel</a></p>
      </form>
      <!--				
