...
<title>CypCom Admin Editor</title>
<script src="../jquery/jquery.js" type="text/javascript" language="javascript"></script>
<script src="search_species.js" type="text/javascript" language="javascript"></script>
</head>
...
<div id="wrap">
	...
	<div id="content-wrap">		
		<div id="main">				
			...
			<p>		
				<label>Please use scientific name to search (my sample is <i>Beaufortia cyclica</i>)</label>
				<input name="keyword" type="text" id="keyword" value="Scientific Name" maxlength="40" size="50"/>
        ...
        <BR>
			  ...
			  <BR>
				...
				<!--<BR>
			    <label>OR</label>
			    <input name="Browse the table" type="text" id="Browse the table" value="Browse the table" maxlength="40" size="50" /><BR><BR>
        <BR>-->
