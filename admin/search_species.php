...
if(mysql_num_rows($result)>0){
	...
	echo "<p><h3>Your Search Result:</h3></p>";
  echo "<table>";
	echo "<tr>";
  echo "<td align=\"center\">Family</td>";
  echo "<td align=\"center\">Genus</td>";
  ...
  while ($nb2=mysql_fetch_array($result)) {
    ...
    echo "<td align=\"center\">".$nb2[1]."</td>";
		...
		echo "<td align=\"center\"><i>".$nb2[3]."</i></td>";		
    /*
    echo "<td align=\"center\"><a href=\"genus.php?family=".$nb2[1]."\">".$nb2[1]."</a>(Change?)</td>";
		...
		echo "<td align=\"center\"><a href=\"speciesEditor.php?family=".$nb2[2]."&species=".$nb2[3]."\">".$nb2[3]."</a></td>";
		*/
    echo "<td align=\"center\"><a href=\"speciesEditor2.php?sid=".$nb2[0]."\">Edit It</a></td>";
		echo "</tr>";
	}
	echo "</table>";
