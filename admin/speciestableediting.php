...
<head>
<title>Taxon Profiles Species Table Editing</title>
...
<!--Here!!-->
<script type="text/javascript" src="speciestableediting.js"></script><!-- specific js for this page. -->
<!--Here!!-->
