...
<div id="wrap">
  ...
  <div id="content-wrap">
    <div id="main">
      <h4>Hi, <font color="blue"><? echo $_SESSION['username'];?></font>. Welcome to your login history page.</h4>
...
$sql = "SELECT * FROM userloghis WHERE username = '".$_SESSION['username']."'";
...
if(mysql_num_rows($result)>0){
	...
	echo "<table>";
	echo "<tr><td align=\"center\">Series id</td><td align=\"center\">username</td><td align=\"center\">log time</td><td align=\"center\">log type</td>";
	while ($nb2=mysql_fetch_array($result)) {
		echo "<tr bgcolor=\"#FDDC99\">";
		echo "<td align=\"center\">".$nb2[0]."</td>";
