...
<title>Taxon Profiles Personal Information Editting</title>
...
$colname = array("Series Number","Login name","passwd","Name", "Address", "Telephone Number", "Fax Number", "Email", "Your website", "Your photo", "Group of Cypriniformes Interest", "Research Interest", "Hobby Interest", "Where you comes from?", "Education", "Field of your study", "actlevel", "role", "will", "19", "20", "21", "22", "23", "Register Date and Time");
...
if(mysql_num_rows($result)>0){
	...
	//echo "\$row['uid'] is :: ".$row['uid']."<br>\n";
	//echo $row[1]."<br>";
	//echo $row[2]."<br>";
	//echo $row[3]."<br>";
	//echo $row[4]."<br>this is a test!!<br>";
	//$row['passwd']
	for($i=0;$i<sizeof($row);$i++){
		...
		if($i == 9){
			...
			echo "<br>";
			if($row[$i] != ""){
				echo "<img width=\"360\" src=\"view.php?username=".$_SESSION['username']."\">";
				echo "<a href=\"delete_usr_photo.php?uid=".$row[0]."\">Delete this picture</a>";
			}
			echo "<br>";
			echo "<a href=\"uploadphotoform.php\">Upload and modify your profile picture</a><BR /><BR />";
			
			//echo "<a href=\"delete_usr_photo.php?uid=".$row['uid']."\">Delete this picture</a>";
		...
		//}else if($i == 0 || $i == 1){
			...
			echo "</td>";
			echo "</tr>";		
		}else if($i == 0 || $i == 2 || $i == 16 || $i == 17 || $i == 18 || $i == 19 || $i == 20 || $i == 21 || $i == 22 || $i == 23){
			//do nothing
			//echo "";
		}else{
			echo "<tr>";
			...
			echo "</td>";
			echo "<td>";
			echo "<div class=\"edit\" id=\"user_".mysql_field_name ($result, $i)."_".$row[0]."\">".$row[$i]."</div>";
			echo "</td>";
			echo "</tr>";
		}
	}
	...
	//echo "<div class=\"edit other_class\" id=\"user_username_".$row['uid']."\">".$row['username']."</div>";
	//echo "<div class=\"edit other_class\" id=\"user_passwd_".$row['uid']."\">".$row['passwd']."</div>";
	//echo "<div class=\"edit other_class\" id=\"user_eml_".$row['uid']."\">".$row['eml']."</div>";
...
?>
        ...
        <tr><td colspan="2"><a href="useradmin.php">Back to admin page</a></td></tr>
      </table>
      <!--				
