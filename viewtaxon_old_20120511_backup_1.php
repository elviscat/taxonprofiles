...
<title>Taxon Profiles View Account</title>
                ...
                if(mysql_num_rows($result)>0){
                  ...
                  while ($nb2=mysql_fetch_array($result)) {
                    echo "<tr bgcolor=\"#FDDC99\">";
	                  ...
	                  echo "<td align=\"center\"><i>".$nb2[4]."</i></td>";
	                  echo "</tr>";
	                  echo "<tr bgcolor=\"#FDDC99\">";
	                  echo "<td align=\"center\">Type Locality</td>";
	                  echo "<td align=\"center\"><i>".$nb2[5]."</i></td>";
	                  echo "</tr>";
	                  echo "<tr bgcolor=\"#FDDC99\">";
	                  echo "<td align=\"center\">C_Code</td>";
	                  echo "<td align=\"center\"><i>".$nb2[6]."</i></td>";
	                  echo "</tr>";
	                  echo "<tr bgcolor=\"#FDDC99\">";
	                  echo "<td align=\"center\">Paese</td>";
	                  echo "<td align=\"center\"><i>".$nb2[7]."</i></td>";
	                  echo "</tr>";	                	                
                  }
                  echo "</table>";
                }else{
