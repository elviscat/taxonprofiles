...
<title>Taxon Profiles Account Register</title>
<script src="jquery/jquery.js" type="text/javascript" language="javascript"></script>
<script src="register/register_check.js" type="text/javascript" language="javascript"></script>
<link rel=stylesheet type="text/css" href="register/register_check.css">
</head>
...
<div id="wrap">
	...
	<div id="content-wrap">
		...
		<div id="main">				
			<h3>New User Account Register</h3>
            <p>Please fill out the following information</p>
			<form method="post" action="" id="register_form">
			<p>		
				<label>User Account Name (Login Name) : </label>
				<input name="username" type="text" id="username" value="User Account Name" maxlength="20" size="40" /><BR />
                <font color="red">*From 6 to 20 characters, with combination with alpha and number</font>
                <!--<input name="username" value="Your Name" type="text" size="30" />-->
				<label>Password : </label>
				<input name="password" type="password" id="password" value="0123456789" maxlength="20" size="40" /><BR />
                <font color="red">*From 6 to 20 characters, with combination with alpha and number</font>
                <label>Password Again: </label>
				<input name="passwordagain" type="password" id="passwordagain" value="0123456789" maxlength="20" size="40" /><BR />
                <font color="red">*Please re-type your password again</font>
                <label>Email Address: </label>
				<input name="eml" type="text" id="eml" value="user@taxonprofiles.org" maxlength="40" size="60" /><BR />
                <font color="red">*Please key in your email address</font>
				<label>Email Address Again: </label>
				<input name="emlagain" type="text" id="emlagain" value="user@taxonprofiles.org" maxlength="40" size="60" /><BR />
                <font color="red">*Please re-type your password again</font><BR /><BR />
