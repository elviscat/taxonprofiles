...
<title>CypCom Add a New Family</title>
<script src="jquery/jquery.js" type="text/javascript" language="javascript"></script>
<script src="userfamilyadd/userfamilyadd.js" type="text/javascript" language="javascript"></script>
<link rel=stylesheet type="text/css" href="userfamilyadd/userfamilyadd.css">
</head>
...
<div id="msg"></div>
			...
			<h3>Add a new Family under your view</h3>		
			
            <p>		
				<label>Family Name : </label>
				<input name="family_name" type="text" id="family_name" value="" maxlength="50" size="50" />
				<label>Description : </label>
				<textarea name="family_desc" id="family_desc" value="" COLS="40" ROWS="6"></textarea><br>
                
                <input class="button" type="submit" value="Add" name="Submit" id="submit" />
