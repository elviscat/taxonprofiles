...
<title>Taxon Profiels User Admin Dashboard</title>
...
<div id="wrap">
  ...
  <div id="content-wrap">
    <div id="main">
      <p>Hi <font color="blue"><?PHP echo $_SESSION['username']." (".$_SESSION['name'].")"; ?></font>,<BR /> Welcome to your admin manage page.</p>
      <h3>Profile Editing</h3>
      <form method="post" action="" id="edit_profile_form">
        <p>
      	<a href="userprofileedit.php">Edit your basic profile</a>
		<!--<a href="userprofileedit.php">Edit your basic profile(OK)</a>-->
        </p>
        <p>
		<!--<a href="contriedit.php">Edit your contributions to Cypriniformes Commons</a>-->
        </p>
      </form>
      
      <!--
      <h3>Blog</h3>
      <form method="post" action="" id="blog">
        <p>
		<a href="blog/manage.php">Go to your Blog!</a>
        </p>
      </form>
      -->
		<h3>Update to Taxa (Data or Review)</h3>
		<form method="post" action="" id="edit_contribution_form">
		<p>
			<a href="docadmin.php?doc_level=author">By Tree-View Biological Classification</a>
		</p>
		<p>
			<a href="docadmin.php?doc_level=reviewer">By Search Taxa</a>
		</p>
		</form>
		
		
      <!--<h3>Contribution Editing</h3>-->
      <h3>Contribution Management</h3>
      <form method="post" action="" id="edit_contribution_form">
		<p>
		<a href="docadmin.php?doc_level=author">Manage the taxon profiles-document that you author</a>
        </p>
        <p>
		<a href="docadmin.php?doc_level=reviewer">Manage the taxon profiles-document that you review</a>
        </p>
        <!--
        <p>
		<a href="docadmin.php?doc_level=author">Manage the taxon accounts that you author</a>
        </p>
        <p>
		<a href="docadmin.php?doc_level=reviewer">Manage your profile as reviewer of accounts</a>
        </p>
        <p>
		<a href="accountadmin.php">View your current profile as author and reviewer</a>
        </p>
        
        <p>
		<a href="managetsacc.php">Manage your Taxa/Species Account(not yet)</a>
        </p>
        -->
      ...
      <!--
      <h3>History</h3>
      <form method="post" action="" id="view_history_form">
        <p>
		<a href="loghis.php">Login/Logout History(OK, but need page)</a>
        </p>
        <p>
		<a href="spedithis.php">Taxa/Species Account Editing History(not yet)</a>
        </p>
      </form>
      -->
      <!--				
