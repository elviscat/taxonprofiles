...
<title>Taxon Profiles Request Password</title>
<script src="jquery/jquery.js" type="text/javascript" language="javascript"></script>
<script src="request_passwd/request_passwd.js" type="text/javascript" language="javascript"></script>
<link rel=stylesheet type="text/css" href="request_passwd/request_passwd.css">
</head>
...
<div id="wrap">
	...
	<div id="content-wrap">
		...
		<div id="main">				
			...
			<form method="post" action="" id="request_passwd_form">			
			<p>		
				<label>User Name : </label>
				<input name="username" type="text" id="username" value="User Name" maxlength="20" size="40" />
                <!--<input name="username" value="Your Name" type="text" size="30" />-->
				<label>Email Address : </label>
				<input name="eml" type="text" id="eml" value="aaa@bbb.ccc" maxlength="40" size="40"/>
                <!--<input name="demail" value="Your Email" type="text" size="30" />-->
				<!--<label>Your Comments</label>
				<textarea rows="5" cols="5"></textarea>
				<br />-->	
				<input class="button" type="reset" value="Reset" />&nbsp;&nbsp;
                <input class="button" type="submit" value="Request" name="Submit" id="submit" />
