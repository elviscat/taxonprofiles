...
<title>CypCom Edit your contribution</title>
<script src="jquery/jquery.js" type="text/javascript" language="javascript"></script>
<script src="contriform/contriform.js" type="text/javascript" language="javascript"></script>
<link rel=stylesheet type="text/css" href="contriform/contriform.css">
</head>
...
$sql = "SELECT contri1,contri2,contri3,contri4 FROM user WHERE username = '".$_SESSION['username']."'";
$result = mysql_query ($sql) or die ("Invalid query");
$row = mysql_fetch_row($result);
//
$exchange;
$sig;
$wtb;//delclare the variable "willingtobook"
...
<div id="msg"></div>
			...
			<h3>Set up your contribution parameters</h3>
			<!--<form method="post" action="" id="contri_form">-->			
			<p>		
				<label>1.Are you interested in any exchange of live Cypriniformes species for hobby?</label>
				<?
					for($i=0;$i<2;$i++){
						$para = array("1","0");
						$para2 = array("Yes","No");
						...
						echo "<input name=\"exchange\" type=\"radio\" id=\"exchange\" value=\"".$para[$i]."\" ".$checked." />&nbsp;&nbsp;".$para2[$i]."&nbsp;&nbsp;";
					}					
				?>
                <!--<input name="username" value="Your Name" type="text" size="30" />-->
				<label>2.Are you interested in joining a research group on Cypriniformes? If yes, please check the boxes below as to your research interests.</label>
				<?
					//First, set up the sig format
					$sig_format = array("Ecology","Evolution","Genetics","Biogeography","Behavior","Captive Breeding","Conservation","Systematics","Morphology");

					for($i=0;$i<sizeof($sig_format);$i++){
						//echo $sig;
						$checked = "";
						$test = explode(";", $sig);
						//echo $test[2];
						...
						echo "<input name=\"sig".($i+1)."\" type=\"checkbox\" id=\"sig".($i+1)."\" value=\"".($i+1)."\" ".$checked."/>&nbsp;&nbsp;".$sig_format[$i]."&nbsp;&nbsp;";
					}					
					

				?>                
                
                <label>3.Do you have photographs of live species of Cypriniformes that you would be willing to contribute to an upcoming book on the Biology of Cypriniformes?</label>
				<?
					for($i=0;$i<2;$i++){
						$para = array("1","0");
						$para2 = array("Yes","No");
						...
						echo "<input name=\"willingtobook\" type=\"radio\" id=\"willingtobook\" value=\"".$para[$i]."\" ".$checked." />&nbsp;&nbsp;".$para2[$i]."&nbsp;&nbsp;";
					}					
				?>                
                <!--
                <input name="willingtobook" type="radio" id="willingtobook" value="1" />&nbsp;&nbsp;Yes&nbsp;&nbsp;
                <input name="willingtobook" type="radio" id="willingtobook" vlaue="0" />&nbsp;&nbsp;No&nbsp;&nbsp;
                -->
                <label>Are you willing to serve as an editor for a taxon?</label>
				<?
					for($i=0;$i<2;$i++){
						$para = array("1","0");
						$para2 = array("Yes","No");
						...
						echo "<input name=\"willingtotaxon\" type=\"radio\" id=\"willingtotaxon\" value=\"".$para[$i]."\" ".$checked." />&nbsp;&nbsp;".$para2[$i]."&nbsp;&nbsp;";
					}					
				...
				?>                
                <!--
                <input name="willingtotaxon" type="radio" id="willingtotaxon" value="1" />&nbsp;&nbsp;Yes&nbsp;&nbsp;
                <input name="willingtotaxon" type="radio" id="willingtotaxon" vlaue="0" />&nbsp;&nbsp;No&nbsp;&nbsp;
                -->
                <br>
                <br>
                ...
                <input class="button" type="submit" value="Save and Send" name="Submit" id="submit" />
